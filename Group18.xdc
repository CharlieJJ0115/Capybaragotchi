...
## Pmod Header JA - PmodJSTK (Joystick)
## Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {JSTK_SS}]
   set_property IOSTANDARD LVCMOS33 [get_ports {JSTK_SS}]
## Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {JSTK_MOSI}]
   set_property IOSTANDARD LVCMOS33 [get_ports {JSTK_MOSI}]
## Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {JSTK_MISO}]
   set_property IOSTANDARD LVCMOS33 [get_ports {JSTK_MISO}]
## Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {JSTK_SCLK}]
...
## Sch name = JB3
 set_property PACKAGE_PIN B15 [get_ports {RES}]
    set_property IOSTANDARD LVCMOS33 [get_ports {RES}]
## Sch name = JB4
 set_property PACKAGE_PIN B16 [get_ports {DC}]
    set_property IOSTANDARD LVCMOS33 [get_ports {DC}]
## Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {SS}]
   set_property IOSTANDARD LVCMOS33 [get_ports {SS}]
## Sch name = JB8
 set_property PACKAGE_PIN A17 [get_ports {BC}]
...
## Sch name = JC2
#set_property PACKAGE_PIN M18 [get_ports {Trig}]
